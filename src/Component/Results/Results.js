...
const Results = () => {
  ...
  const [singleResult, setSignleResult] = useState({
  ...
  const handleSubmit = (e) => {
    ...
    // setSignleResult(resultID.find(result => result.SID == query))



    if (resultID.find(d => d.SID == query)) {
      resultID.map(d => d.SID == query && setSignleResult(d))
      setErr(false)
    }
    else setErr(true)
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            ...
            {!err ? <div className="card-body shadow bg-card">
